...
var PaymentService = /** @class */ (function () {
     ...
     */
    PaymentService.prototype.createOrder = function (amount_1) {
        return __awaiter(this, arguments, void 0, function (amount, currency, receipt) {
     ...
     */
    PaymentService.prototype.verifySignature = function (orderId, paymentId, signature) {
        var hmac = crypto_1.default.createHmac('sha256', process.env.RAZORPAY_KEY_SECRET);
