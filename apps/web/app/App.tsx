...
const systems = [
  ...
  { step: '04', label: 'DELIVER · MONETIZE', title: 'Deliver securely and monetize', text: 'Track chain of custody, control access, deliver approved assets and manage commercial outcomes.', href: '/crayons-bridge' },
];
...
export default function App() {
  return <BrowserRouter><Routes>
    ...
    <Route path="/ott-ready" element={<OTTRready />} />
    <Route path="/profile" element={<ProtectedRoute><Profile /></ProtectedRoute>} />
    <Route path="/dashboard" element={<ProtectedRoute><CrayonsBridge /></ProtectedRoute>} />
    <Route path="/creator-studio" element={<ProtectedRoute><CrayonsBridge /></ProtectedRoute>} />
    ...
    <Route path="/simple-mvp" element={<SimpleMVP />} />
