    ...
    >
      ...
      <section className="mx-auto max-w-7xl px-5 pb-20 pt-20 md:px-8 md:pb-28 md:pt-28">
        <div className="max-w-5xl">
          <div className="mb-7 inline-flex items-center rounded-full border border-white/10 bg-white/[0.03] px-4 py-2 text-xs text-white/45">For filmmakers, creators, studios and visual teams</div>
          <h1 className="text-5xl font-medium tracking-[-0.045em] md:text-7xl lg:text-8xl">The Operating System for Visual Content — From Idea to Release.</h1>
          <p className="mt-7 max-w-3xl text-base leading-7 text-white/48 md:text-lg">Create projects. Protect rights. Connect with buyers. Deliver content seamlessly.</p>
          <div className="mt-5 max-w-3xl text-sm leading-6 text-white/35 md:text-base">One connected ecosystem for creation, rights protection, verification, buyer matching, licensing, secure delivery and monetization.</div>
          <div className="mt-9 flex flex-wrap gap-3">
            ...
            <Link to="/crayons-bridge" className="rounded-full border border-white/10 bg-white/[0.03] px-6 py-3 text-sm font-semibold text-white/75 transition hover:border-white/20 hover:bg-white/[0.06]">Open Bridge</Link>
            <Link to="/pricing" className="rounded-full border border-white/10 bg-white/[0.03] px-6 py-3 text-sm font-semibold text-white/75 transition hover:border-white/20 hover:bg-white/[0.06]">Explore Plans</Link>
          </div>
        </div>
      </section>
      ...
      <section id="ecosystem" className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-24">
        <div className="mb-10 max-w-3xl">
          <p className="text-xs font-semibold tracking-[0.24em] text-white/30">ONE OPERATING WORKFLOW</p>
          <h2 className="mt-4 text-3xl font-medium tracking-tight md:text-5xl">Create → Protect → Verify → Match → License → Deliver → Monetize</h2>
          <p className="mt-4 text-base leading-7 text-white/42">Your content, rights, commercial records and delivery workflow stay connected from the first idea to release.</p>
        </div>
      ...
      <section className="border-y border-white/[0.07] bg-white/[0.015]">
        <div className="mx-auto grid max-w-7xl gap-12 px-5 py-20 md:px-8 md:py-28 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-3xl font-medium tracking-tight md:text-5xl">Monetize finished content with complete control.</h2>
            <p className="mt-5 max-w-xl text-base leading-7 text-white/42">Move from QC and rights verification to buyer matching, licensing, secure asset delivery and payment — with commercial control built into the workflow.</p>
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              {[
                ...
                <div key={item} className="flex items-center gap-3 rounded-xl border border-white/[0.07] bg-white/[0.02] px-4 py-4">
                  <span className="text-[10px] text-white/25">{String(index + 1).padStart(2, '0')}</span>
      ...
      <section className="mx-auto max-w-7xl px-5 py-20 md:px-8 md:py-28">
        <div className="max-w-3xl">
          <p className="text-xs font-semibold tracking-[0.24em] text-white/30">RIGHTS INFRASTRUCTURE</p>
          <h2 className="mt-4 text-3xl font-medium tracking-tight md:text-5xl">From creation to a buyer-ready, release-ready asset.</h2>
          <p className="mt-5 text-base leading-7 text-white/42">Standardize the commercial journey with professional metadata, rights verification, clearances, buyer access controls, licensing records and secure delivery.</p>
        </div>
        <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ['Secure', 'Protected assets and rights-controlled access'],
            ['Verified', 'QC, clearance and rights evidence'],
            ['Commercial', 'Buyer matching, licensing and approvals'],
            ['Traceable', 'Chain-of-custody and delivery records'],
          ].map(([title, text]) => (
      ...
      <section className="border-t border-white/[0.07] bg-white/[0.01]">
        <div className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-20">
          <p className="text-xs font-semibold tracking-[0.24em] text-white/30">THE STREAMVISTA PROMISE</p>
          <p className="mt-5 max-w-4xl text-2xl leading-10 tracking-tight text-white/78 md:text-4xl md:leading-tight">StreamVista is the Operating System for Visual Content — helping creators create, protect rights, connect with buyers, license content, and deliver securely from idea to release.</p>
          <p className="mt-5 max-w-4xl text-base leading-7 text-white/38 md:text-lg">Visual Content-ന്റെ Operating System; ആശയത്തിൽ നിന്ന് release വരെ creation, rights protection, buyer connection, licensing, secure delivery എന്നിവ ഒരൊറ്റ ecosystem-ൽ.</p>
        </div>
      </section>
      ...
      <footer className="border-t border-white/[0.07]">
        <div className="mx-auto flex max-w-7xl flex-col gap-5 px-5 py-12 md:px-8 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <div className="mt-2 text-sm text-white/30">The Operating System for Visual Content.</div>
          </div>
