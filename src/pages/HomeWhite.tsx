  ...
  return (
    <main className="min-h-screen bg-[#F9F6F0] text-[#111111]">
      <header className="mx-auto flex max-w-7xl items-center justify-between px-6 py-7 lg:px-10">
        <a href="/home" className="flex items-center gap-3 font-black tracking-[-0.05em] text-[#1E4FC7]">
      ...
      <section className="mx-auto grid min-h-[620px] max-w-7xl items-center gap-12 px-6 py-12 lg:grid-cols-[1.05fr_.95fr] lg:px-10 lg:py-16">
        <div>
          ...
          <h1 className="mt-6 max-w-3xl font-serif text-6xl leading-[0.92] tracking-[-0.055em] sm:text-7xl lg:text-[80px]">
            Stories move here.
          </h1>
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
            <a href="/login?next=/chat" className="inline-flex items-center justify-center gap-2 rounded-full bg-[#1E4FC7] px-6 py-3 text-sm font-bold text-white">
              Talk to StreamVista AI <ArrowRight size={16} />
            </a>
            <a href="/login" className="text-sm font-semibold text-zinc-700 hover:text-black">Already have an account? Sign in</a>
          </div>
        </div>
